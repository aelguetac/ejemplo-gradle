...
//	Build Failure: [Nombre Alumno][Nombre Job][buildTool] Ejecución fallida en stage [Stage]
	slackSend color: 'good', message: "Build status SUCCESS: [Alejandro Elgueta] [${env.JOB_NAME}}] [${params.herramienta}] Ejecucion exitosa\nURL : [${env.BUID_URL}]", teamDomain: 'devops-usach-2020', tokenCredentialId: 'slack'
			...
			failure {
                        //        steps {
                        //        script {
	slackSend color: 'danger', message: "Build status FAILURE: [Alejandro Elgueta] [${params.herramienta}] Ejecucion fallida en stage [${TAREA}]\nURL : [${env.BUID_URL}}]", teamDomain: 'devops-usach-2020', tokenCredentialId: 'slack'
