...
//	Build Failure: [Nombre Alumno][Nombre Job][buildTool] Ejecución fallida en stage [Stage]
	slackSend color: 'good', message: "Build status SUCCESS: [Alejandro Elgueta] [${env.JOB_NAME}}] [${params.herramienta}] Ejecucion exitosa", teamDomain: 'devops-usach-2020', tokenCredentialId: 'slack'
